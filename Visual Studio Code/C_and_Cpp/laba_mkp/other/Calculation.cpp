...
void calculation(double time) {
	...
	std::string path = "C:/projects/Visual Studio Code/C_and_Cpp/laba_mkp/other/" + filename;
...
void calculate_density_and_acceleration(double H, double radial_vel, double transversal_vel, double vel, std::string path) {
	...
	data_input.open("C:/projects/Visual Studio Code/C_and_Cpp/laba_mkp/other/acceleration_data.txt");
	file.open(path, std::ofstream::app);
