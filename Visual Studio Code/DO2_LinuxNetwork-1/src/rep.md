...
![ipcalc](/DO2_LinuxNetwork-1/src/D02_photo/ipcalc192.png)

##### 2) Перевод маски *255.255.255.0* в префиксную и двоичную запись, */15* в обычную и двоичную, *11111111.11111111.11111111.11110000* в обычную и префиксную

![ipcalc1](/DO2_LinuxNetwork-1/src/D02_photo/ipcalc255.png)

![ipcalc2](/DO2_LinuxNetwork-1/src/D02_photo/ipcalc15.png)

![ipcalc3](/DO2_LinuxNetwork-1/src/D02_photo/ipcalc1111.png)

##### 3) Минимальный и максимальный хост в сети *12.167.38.4* при масках: */8*, *11111111.11111111.00000000.00000000*, *255.255.254.0* и */4*

![ipcalc4](/DO2_LinuxNetwork-1/src/D02_photo/ipcalc12167384.png)

![ipcalc5](/DO2_LinuxNetwork-1/src/D02_photo/ipcalc121673841111.png)

![ipcalc6](/DO2_LinuxNetwork-1/src/D02_photo/ipcalc12167384255254.png)
...
![ipcalc7](/DO2_LinuxNetwork-1/src/D02_photo/1.2.1.png)

- Проверка 127.0.0.2 P.s. подходит

![ipcalc8](/DO2_LinuxNetwork-1/src/D02_photo/1.2.2.png)

- Проверка 128.0.0.1 P.s. не подходит

![ipcalc9](/DO2_LinuxNetwork-1/src/D02_photo/1.2.3.png)

- Проверка 127.1.0.1 P.s. подходит

![ipcalc10](/DO2_LinuxNetwork-1/src/D02_photo/1.2.4.png)
...
![ipcalc11](/DO2_LinuxNetwork-1/src/D02_photo/1.3.1.png)

![ipcalc12](/DO2_LinuxNetwork-1/src/D02_photo/1.3.2.png)

- К публичным: 134.43.0.2, 172.0.2.1, 192.172.0.1, 172.68.0.2, 192.169.168.1

![ipcalc13](/DO2_LinuxNetwork-1/src/D02_photo/1.3.3.png)

![ipcalc14](/DO2_LinuxNetwork-1/src/D02_photo/1.3.4.png)
...
![ipcalc15](/DO2_LinuxNetwork-1/src/D02_photo/1.3.5.png)
...
![ws1-2](/DO2_LinuxNetwork-1/src/D02_photo/2.0.png)

##### С помощью команды `ip a` посмотри существующие сетевые интерфейсы.

![ipa](/DO2_LinuxNetwork-1/src/D02_photo/2.1.png)
...
![2.2](/DO2_LinuxNetwork-1/src/D02_photo/2.2.png)

![2.3](/DO2_LinuxNetwork-1/src/D02_photo/2.3.png)
...
![2.4](/DO2_LinuxNetwork-1/src/D02_photo/2.4.png)

![2.5](/DO2_LinuxNetwork-1/src/D02_photo/2.5.png)
...
![2.6](/DO2_LinuxNetwork-1/src/D02_photo/2.6.png)

![2.7](/DO2_LinuxNetwork-1/src/D02_photo/2.7.png)

##### Пропингуем соединение между машинами.

![2.8](/DO2_LinuxNetwork-1/src/D02_photo/2.8.png)

![2.9](/DO2_LinuxNetwork-1/src/D02_photo/2.9.png)
...
![3.1](/DO2_LinuxNetwork-1/src/D02_photo/3.1.png)
...
![4.1](/DO2_LinuxNetwork-1/src/D02_photo/4.1ws1.png)

![4.11](/DO2_LinuxNetwork-1/src/D02_photo/4.1ws1sb.png)

![4.111](/DO2_LinuxNetwork-1/src/D02_photo/4.1ws2.png)

![4.1111](/DO2_LinuxNetwork-1/src/D02_photo/4.1ws2sb.png)
...
![4.2](/DO2_LinuxNetwork-1/src/D02_photo/2.8.png)

![4.3](/DO2_LinuxNetwork-1/src/D02_photo/2.9.png)

- nmap 

![4.4](/DO2_LinuxNetwork-1/src/D02_photo/nmap.png)
...
![virt](/DO2_LinuxNetwork-1/src/D02_photo/virt.png)
...
![conf1](/DO2_LinuxNetwork-1/src/D02_photo/ws11config.png)

![conf2](/DO2_LinuxNetwork-1/src/D02_photo/ws21config.png)

![conf3](/DO2_LinuxNetwork-1/src/D02_photo/ws22config.png)

![conf4](/DO2_LinuxNetwork-1/src/D02_photo/r1config.png)

![conf5](/DO2_LinuxNetwork-1/src/D02_photo/r2config.png)
...
![ip4.1](/DO2_LinuxNetwork-1/src/D02_photo/ipws11.png)

![ip4.2](/DO2_LinuxNetwork-1/src/D02_photo/ipws21.png)

![ip4.3](/DO2_LinuxNetwork-1/src/D02_photo/ipws22.png)

![ip4.4](/DO2_LinuxNetwork-1/src/D02_photo/ipr1.png)

![ip4.5](/DO2_LinuxNetwork-1/src/D02_photo/ipr2.png)

- Проверю пинги ws22 с ws21 и r1 с ws11 

![ws22ws21](/DO2_LinuxNetwork-1/src/D02_photo/pingws22.png)

![r1ws11](/DO2_LinuxNetwork-1/src/D02_photo/pingr1.png)
...
![ipv4r1](/DO2_LinuxNetwork-1/src/D02_photo/r1ipv4.png)

![ipv4r2](/DO2_LinuxNetwork-1/src/D02_photo/r2ipv4.png)
...
![forwardr1](/DO2_LinuxNetwork-1/src/D02_photo/r1forward.png)

- r1

![forwardr2](/DO2_LinuxNetwork-1/src/D02_photo/r2forward.png)
...
![configr1](/DO2_LinuxNetwork-1/src/D02_photo/ws11config2.png)

- ws21

![configr2](/DO2_LinuxNetwork-1/src/D02_photo/ws21config2.png)

- ws22

![configr3](/DO2_LinuxNetwork-1/src/D02_photo/ws22config2.png)

##### Вызовим `ip r` и покажем, что добавился маршрут в таблицу маршрутизации.

![ipr1](/DO2_LinuxNetwork-1/src/D02_photo/ws11ipr.png)

![ipr2](/DO2_LinuxNetwork-1/src/D02_photo/ws21ipr.png)

![ipr3](/DO2_LinuxNetwork-1/src/D02_photo/ws22ipr.png)

##### Пропингую с ws11 роутер r2 и покажи на r2, что пинг доходит. Для этого используй команду:
`tcpdump -tn -i eth0`

![pingws11](/DO2_LinuxNetwork-1/src/D02_photo/ws11ping.png)

![tcpdumpr2](/DO2_LinuxNetwork-1/src/D02_photo/r2tcpdump.png)
...
![r1config](/DO2_LinuxNetwork-1/src/D02_photo/r1config2.png)

![r2config](/DO2_LinuxNetwork-1/src/D02_photo/r2config2.png)
...
```
![r1ipr](/DO2_LinuxNetwork-1/src/D02_photo/r1ipr.png)

![r2ipr](/DO2_LinuxNetwork-1/src/D02_photo/r2ipr.png)

##### Запустим команды на ws11:
`ip r list 10.10.0.0/[маска сети]` и `ip r list 0.0.0.0/0`

![ws11ipr](/DO2_LinuxNetwork-1/src/D02_photo/ws11ipr2.png)
...
![traceroute](/DO2_LinuxNetwork-1/src/D02_photo/ws11traceroute.png)

![tcpdumprrr](/DO2_LinuxNetwork-1/src/D02_photo/r1tcpdump.png)
...
![tcpdump -n -i eth0 icmp](/DO2_LinuxNetwork-1/src/D02_photo/r1icmp.png)

![ping -c 1 10.30.0.111](/DO2_LinuxNetwork-1/src/D02_photo/ws11ping4.png)
...
![6.1](/DO2_LinuxNetwork-1/src/D02_photo/6.1.png)

##### 2) В файле *resolv.conf* пропишим `nameserver 8.8.8.8`.

![6.2.0](/DO2_LinuxNetwork-1/src/D02_photo/6.2.0.png)
...
![6.2](/DO2_LinuxNetwork-1/src/D02_photo/6.2.png)

- Пинг ws22 с ws21

![6.3](/DO2_LinuxNetwork-1/src/D02_photo/6.3.png)
...
![6.4](/DO2_LinuxNetwork-1/src/D02_photo/6.4.png)

##### Для r1 настроим аналогично r2, но сделаем выдачу адресов с жесткой привязкой к MAC-адресу (ws11). Проведём аналогичные тесты.

![6.5](/DO2_LinuxNetwork-1/src/D02_photo/6.5.png)

- Редактируем `/etc/resolv.conf` и перезагружаем DHCP

![6.6](/DO2_LinuxNetwork-1/src/D02_photo/6.6.png)

- Перезагружаем ws11 через sudo reboot и вызываю ip a (ip получен)

![6.7](/DO2_LinuxNetwork-1/src/D02_photo/6.7.png)

- Пингуем ws22 c ws11 

![6.8](/DO2_LinuxNetwork-1/src/D02_photo/6.8.png)

##### Запросим с ws21 обновление IP-адреса.

![6.9](/DO2_LinuxNetwork-1/src/D02_photo/6.9.png)

- Запросим у ws21 обновление IP через sudo dhclient -v
    - v - будет выведена дополнительная информация.

![6.10](/DO2_LinuxNetwork-1/src/D02_photo/6.10.png)

- Проверка IP

![6.11](/DO2_LinuxNetwork-1/src/D02_photo/6.11.png)
...
![7.1](/DO2_LinuxNetwork-1/src/D02_photo/7.1.png)

![7.2](/DO2_LinuxNetwork-1/src/D02_photo/7.2.png)

##### Запустим веб-сервер Apache командой `service apache2 start` на ws22 и r1.

![7.3](/DO2_LinuxNetwork-1/src/D02_photo/7.3.png)

![7.4](/DO2_LinuxNetwork-1/src/D02_photo/7.4.png)
...
![7.5](/DO2_LinuxNetwork-1/src/D02_photo/7.5.png)

##### Запустим файл также, как в Части 4.

![7.7](/DO2_LinuxNetwork-1/src/D02_photo/7.7.png)

##### Проверим соединение между ws22 и r1 командой `ping`.
*При запуске файла с этими правилами, ws22 не должна «пинговаться» с r1.*

![7.8](/DO2_LinuxNetwork-1/src/D02_photo/7.8.png)

##### Добавим в файл ещё одно правило:
##### 4) Разрешить маршрутизацию всех пакетов протокола **ICMP**.

![7.9.1](/DO2_LinuxNetwork-1/src/D02_photo/7.9.1.png)

##### Запусти файл также, как в Части 4.

![7.10-7](/DO2_LinuxNetwork-1/src/D02_photo/7.7.png)


##### Проверим соединение между ws22 и r1 командой `ping`.
*При запуске файла с этими правилами, ws22 должна «пинговаться» с r1.*

![7.11](/DO2_LinuxNetwork-1/src/D02_photo/7.11.png)
...
![7.9-12](/DO2_LinuxNetwork-1/src/D02_photo/7.9.png)

##### Запустим файл также, как в Части 4.
*Перед тестированием рекомендуется отключить сетевой интерфейс **NAT** (его наличие можно проверить командой `ip a`) в VirtualBox, если он включен.*

![7.10-7-13](/DO2_LinuxNetwork-1/src/D02_photo/7.7.png)

##### Проверим соединение по TCP для **SNAT**: для этого с ws22 подключиться к серверу Apache на r1 командой:
`telnet [адрес] [порт]`

![7.10-14](/DO2_LinuxNetwork-1/src/D02_photo/7.10.png)

![7.11-15](/DO2_LinuxNetwork-1/src/D02_photo/7.11.png)

![7.12-16](/DO2_LinuxNetwork-1/src/D02_photo/7.12.png)
...
![7.13-17](/DO2_LinuxNetwork-1/src/D02_photo/7.13.png)

![7.14-18](/DO2_LinuxNetwork-1/src/D02_photo/7.14.png)

![7.15-19](/DO2_LinuxNetwork-1/src/D02_photo/7.15.png)
...
![8.1](/DO2_LinuxNetwork-1/src/D02_photo/8.1.png)
...
![8.2](/DO2_LinuxNetwork-1/src/D02_photo/8.2.png)

![8.3](/DO2_LinuxNetwork-1/src/D02_photo/8.3.png)

##### Воспользуемся *Local TCP forwarding* с ws21 до ws22, чтобы получить доступ к веб-серверу на ws22 с ws21.

![8.4](/DO2_LinuxNetwork-1/src/D02_photo/8.4.png)

![8.5](/DO2_LinuxNetwork-1/src/D02_photo/8.5.png)

##### Воспользуйемся *Remote TCP forwarding* c ws11 до ws22, чтобы получить доступ к веб-серверу на ws22 с ws11.

![8.6](/DO2_LinuxNetwork-1/src/D02_photo/8.6.png)

![8.7](/DO2_LinuxNetwork-1/src/D02_photo/8.7.png)
...
![8.8](/DO2_LinuxNetwork-1/src/D02_photo/8.8.png)
